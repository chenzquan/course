...
public class EnumGenerator {
    ...
    private static void toJson(Class clazz,String key,StringBuffer bufferObject,StringBuffer bufferArray) throws Exception {
        Object [] objects = clazz.getEnumConstants();   //返回枚举类的元素，或null如果此Class对象不表示枚举类型。
        ...
        for (int i=0; i<objects.length; i++){
            ...
            if(getCode == null){
                ...
                bufferObject.append(name.invoke(obj)).append(":{key:\"").append(getCode.invoke(obj)).append("\",value:\"")
                        .append(getDesc.invoke(obj)).append("\"}");
            }
    ...
    /**
     * 驼峰转大写下划线，并去掉 _ENUM
     * @param str  SectionChargeEnum 变成SECTION_CHARGE
     * @return
     */
    ...
    /**
     * 驼峰转下划线 第一位是下划线
     * @param str  SectionChargeEnum 变成 _section_charge_enum
     * @return
     */
